...
8. СТИЛЬ И ПУНКТУАЦИЯ: СТРОЖАЙШИЙ ЗАПРЕТ на избыточное использование длинных тире (—) и многоточий. Используй тире только там, где оно грамматически необходимо (в диалогах или тире между подлежащим и сказуемым), но не для "красоты" или связки предложений. Пиши короткими, емкими предложениями. Если в абзаце больше двух длинных тире — это плохой текст. Избегай пафоса. Текст должен быть реалистичным и жестким.

ЗАДАЧА:

1. Опиши последствия выбора (60% текста). БЕЗ ВОДЫ И ИЗБЫТОЧНЫХ ТИРЕ.
...
ВАЖНО: Пиши лаконично и емко. СТРОЖАЙШИЙ ЗАПРЕТ на избыток длинных тире (—). Не используй тире чаще одного раза на абзац. Избегай пафосных многоточий и тяжелых деепричастных конструкций. Текст должен быть сухим, реалистичным и «рубленым», как в хорошей прозе, а не «акварельно-расплывчатым».
